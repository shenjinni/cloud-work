...
<script type="text/javascript">
    /*$("#f_upload").fileinput({
        ...
        uploadUrl:"${ctx}/common/uploadFile.json", //上传的地址
    ...
    $("#f_upload").fileinput({
        //上传的地址
        uploadUrl:"${ctx}/common/uploadFile.json",
        uploadAsync : true, //默认异步上传
																...
																<div class="input-icon right">
																	<%--<c:choose>
																		<c:when test="${not empty advertisement.adImage}">
																			<img id="ico_image_0" src="${advertisement.adImage }" style="width: 200px;height: 140px;" />
																		</c:when>
																		<c:otherwise>
																	...
																	<div class="input-icon right" style="margin: 5px auto;">
																		<input type="file"  id="ico_input_0"  name="uploadFile" onchange="uploadImage(0, 'ico');"/>
																	</div>
