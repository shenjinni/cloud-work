			...
			<div style="padding-left: 380px;" class="login-item">
				<ul>
					<li>
						...
						<div class="imassage1" id="username_Info" style="color: #CCCCCC">支持字母、数字、"-"、"_"的组合，4-16个字符</div>
					...
					<li>
						...
						<div class="imassage1" id="mobile_Info" style="color: #CCCCCC">完成验证后，您可用该手机找回密码</div>
